...
{
    JButton lbl1,lbl2,lbl3,lbl4,lbl5;
    public Color_Demo()
    {
        lbl1 = new JButton("All The Best");
        lbl1.setForeground(Color.red);
        add(lbl1);
        lbl2 = new JButton("All The Best");
        lbl2.setForeground(Color.magenta);
        add(lbl2);
        lbl3 = new JButton("All The Best");
        lbl3.setForeground(Color.blue);
        add(lbl3);
        lbl4 = new JButton("All The Best");
        lbl4.setForeground(Color.green);
        add(lbl4);
        lbl5 = new JButton("All The Best");
